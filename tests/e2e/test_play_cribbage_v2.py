...
def test_playing_cribbage():
    ...
    win_state_path = os.path.join(base_schema_path, 'cribbage-win-state-schema.json')
    valid_state_path = os.path.join(base_schema_path, 'cribbage-valid-state-schema.json')
    rules = {}
