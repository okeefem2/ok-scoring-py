...
def test_playing_yahtzee():
    ...
    win_state_path = os.path.join(base_schema_path, 'yahtzee-win-state-schema.json')
    valid_state_path = os.path.join(base_schema_path, 'yahtzee-valid-state-schema.json')
    rules = {}
